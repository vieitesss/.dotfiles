...
_G.packer_plugins = {
  LuaSnip = {
    loaded = true,
    path = "/home/vieites/.local/share/nvim/site/pack/packer/start/LuaSnip",
  ...
  cmp_luasnip = {
    loaded = true,
    path = "/home/vieites/.local/share/nvim/site/pack/packer/start/cmp_luasnip",
    url = "https://github.com/saadparwaiz1/cmp_luasnip"
  },
  gruvbox = {
    loaded = true,
    path = "/home/vieites/.local/share/nvim/site/pack/packer/start/gruvbox",
  ...
  ["nvim-jdtls"] = {
    loaded = true,
    path = "/home/vieites/.local/share/nvim/site/pack/packer/start/nvim-jdtls",
  ...
  ["nvim-web-devicons"] = {
    loaded = true,
    path = "/home/vieites/.local/share/nvim/site/pack/packer/start/nvim-web-devicons",
