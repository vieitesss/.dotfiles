...
awful.key({ modkey,           }, "q", function() awful.spawn.with_shell("~/.config/polybar/scripts/powermenu.sh") end,
            {description = "quit awesome", group = "awesome"}),
...
-- Data bar
awful.key({ modkey }, "c", function () awful.spawn.with_shell(string.format("%s/.config/polybar/scripts/data.sh", os.getenv("HOME"))) end,
...
awful.key({ modkey }, "p", function() awful.spawn.with_shell("~/.config/polybar/scripts/launcher.sh") end,
            {description = "show the menubar", group = "launcher"})
--[[dmenu
...
autorunApps={
    ...
    "~/.config/polybar/launch.sh awesome"
}
