...
--local volumecfg = lain.widget.volume_control
...
--            arrow(theme.bg_normal, "#9B8083"),
--            wibox.container.background(wibox.container.margin(wibox.widget { baticon, bat.widget, layout = wibox.layout.align.horizontal }, dpi(3), dpi(3)), "#9B8083"),
--            arrow("#9B8083", "#503B55"),
--            wibox.container.background(wibox.container.margin(wibox.widget { wibox.widget.imagebox(""), wibox.widget.textclock(), layout = wibox.layout.align.horizontal }, dpi(4), dpi(7)), "#503B55"),
