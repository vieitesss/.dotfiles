...
function theme.at_screen_connect(s)
    ...
    s.mywibox:setup {
        ...
        { -- Right widgets
            ...
            arrow("#8DAA9A", "#961ECA"),
            wibox.container.background(wibox.container.margin(wibox.widget { wibox.widget.imagebox(""), wibox.widget.textclock(), layout = wibox.layout.align.horizontal }, dpi(4), dpi(7)), "#961ECA"),
